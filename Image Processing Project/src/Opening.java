...
/* This program performs an opening operation on a black and white image;
 * that is, an erosion operation is performed on an input image, and the
 * resulting image is then subjected to a dilation operation. A one-row-by-
...
public class Opening
{
   ...
   // constructor
   public Opening(String userFileString) throws Exception
   {
      ...
      // performs erosion, then dilation
   ...
   {
      outputFileName = "outputOpening.png";
      try
      {
   ...
   {
      Opening newOpening = new Opening("ExampleImage1.png");
      // retrieves output file name and displays image in Java GUI
      String newImageFile = newOpening.getOutputFileName();
      JFrame newFrame = new JFrame("Opened Image");
